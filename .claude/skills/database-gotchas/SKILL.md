...
description: Live Dev KB query for SQL migrations, RLS policies, triggers, cron jobs and Supabase configuration work. Replaces the drifted static index (2026-07-18).
user-invocable: true
---

# Database Gotchas (live KB wrapper)
...
- **Tags (any of):** supabase, rls, postgres, prisma, migrations, database, postgrest, cron
