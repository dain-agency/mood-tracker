...
**When to use:** invoke this skill BEFORE writing or editing any `/api/ai/*` route, any client hook that calls one, or `scripts/check-ai-route-contract.sh`. The gate lives in `rule-otto-ai-routes`; this skill is the full contract.
